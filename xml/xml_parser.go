// Generated from XMLParser.g4 by ANTLR 4.6.
...
var parserATN = []uint16{
	3, 1072, 54993, 33286, 44333, 17431, 44785, 36224, 43741, 3, 21, 109, 4,
	...
	11, 5, 3, 5, 5, 5, 86, 10, 5, 3, 6, 3, 6, 3, 7, 7, 7, 91, 10, 7, 12, 7,
	14, 7, 94, 11, 7, 3, 7, 3, 7, 3, 7, 3, 7, 7, 7, 100, 10, 7, 12, 7, 14,
	7, 103, 11, 7, 3, 8, 3, 8, 3, 9, 3, 9, 3, 9, 2, 2, 10, 2, 4, 6, 8, 10,
	12, 14, 16, 2, 5, 3, 2, 6, 7, 4, 2, 8, 8, 11, 11, 5, 2, 3, 3, 8, 8, 20,
	20, 116, 2, 19, 3, 2, 2, 2, 4, 34, 3, 2, 2, 2, 6, 44, 3, 2, 2, 2, 8, 85,
	3, 2, 2, 2, 10, 87, 3, 2, 2, 2, 12, 92, 3, 2, 2, 2, 14, 104, 3, 2, 2, 2,
	16, 106, 3, 2, 2, 2, 18, 20, 5, 4, 3, 2, 19, 18, 3, 2, 2, 2, 19, 20, 3,
	2, 2, 2, 20, 24, 3, 2, 2, 2, 21, 23, 5, 16, 9, 2, 22, 21, 3, 2, 2, 2, 23,
	26, 3, 2, 2, 2, 24, 22, 3, 2, 2, 2, 24, 25, 3, 2, 2, 2, 25, 27, 3, 2, 2,
	2, 26, 24, 3, 2, 2, 2, 27, 31, 5, 8, 5, 2, 28, 30, 5, 16, 9, 2, 29, 28,
	3, 2, 2, 2, 30, 33, 3, 2, 2, 2, 31, 29, 3, 2, 2, 2, 31, 32, 3, 2, 2, 2,
	32, 3, 3, 2, 2, 2, 33, 31, 3, 2, 2, 2, 34, 38, 7, 10, 2, 2, 35, 37, 5,
	12, 7, 2, 36, 35, 3, 2, 2, 2, 37, 40, 3, 2, 2, 2, 38, 36, 3, 2, 2, 2, 38,
	39, 3, 2, 2, 2, 39, 41, 3, 2, 2, 2, 40, 38, 3, 2, 2, 2, 41, 42, 7, 13,
	2, 2, 42, 5, 3, 2, 2, 2, 43, 45, 5, 14, 8, 2, 44, 43, 3, 2, 2, 2, 44, 45,
	3, 2, 2, 2, 45, 58, 3, 2, 2, 2, 46, 52, 5, 8, 5, 2, 47, 52, 5, 10, 6, 2,
	48, 52, 7, 4, 2, 2, 49, 52, 7, 20, 2, 2, 50, 52, 7, 3, 2, 2, 51, 46, 3,
	2, 2, 2, 51, 47, 3, 2, 2, 2, 51, 48, 3, 2, 2, 2, 51, 49, 3, 2, 2, 2, 51,
	50, 3, 2, 2, 2, 52, 54, 3, 2, 2, 2, 53, 55, 5, 14, 8, 2, 54, 53, 3, 2,
	2, 2, 54, 55, 3, 2, 2, 2, 55, 57, 3, 2, 2, 2, 56, 51, 3, 2, 2, 2, 57, 60,
	3, 2, 2, 2, 58, 56, 3, 2, 2, 2, 58, 59, 3, 2, 2, 2, 59, 7, 3, 2, 2, 2,
	60, 58, 3, 2, 2, 2, 61, 62, 7, 9, 2, 2, 62, 66, 7, 18, 2, 2, 63, 65, 5,
	12, 7, 2, 64, 63, 3, 2, 2, 2, 65, 68, 3, 2, 2, 2, 66, 64, 3, 2, 2, 2, 66,
	67, 3, 2, 2, 2, 67, 69, 3, 2, 2, 2, 68, 66, 3, 2, 2, 2, 69, 70, 7, 12,
	2, 2, 70, 71, 5, 6, 4, 2, 71, 72, 7, 9, 2, 2, 72, 73, 7, 15, 2, 2, 73,
	74, 7, 18, 2, 2, 74, 75, 7, 12, 2, 2, 75, 86, 3, 2, 2, 2, 76, 77, 7, 9,
	2, 2, 77, 81, 7, 18, 2, 2, 78, 80, 5, 12, 7, 2, 79, 78, 3, 2, 2, 2, 80,
	83, 3, 2, 2, 2, 81, 79, 3, 2, 2, 2, 81, 82, 3, 2, 2, 2, 82, 84, 3, 2, 2,
	2, 83, 81, 3, 2, 2, 2, 84, 86, 7, 14, 2, 2, 85, 61, 3, 2, 2, 2, 85, 76,
	3, 2, 2, 2, 86, 9, 3, 2, 2, 2, 87, 88, 9, 2, 2, 2, 88, 11, 3, 2, 2, 2,
	89, 91, 7, 19, 2, 2, 90, 89, 3, 2, 2, 2, 91, 94, 3, 2, 2, 2, 92, 90, 3,
	2, 2, 2, 92, 93, 3, 2, 2, 2, 93, 95, 3, 2, 2, 2, 94, 92, 3, 2, 2, 2, 95,
	96, 7, 18, 2, 2, 96, 97, 7, 16, 2, 2, 97, 101, 7, 17, 2, 2, 98, 100, 7,
	19, 2, 2, 99, 98, 3, 2, 2, 2, 100, 103, 3, 2, 2, 2, 101, 99, 3, 2, 2, 2,
	101, 102, 3, 2, 2, 2, 102, 13, 3, 2, 2, 2, 103, 101, 3, 2, 2, 2, 104, 105,
	9, 3, 2, 2, 105, 15, 3, 2, 2, 2, 106, 107, 9, 4, 2, 2, 107, 17, 3, 2, 2,
	2, 15, 19, 24, 31, 38, 44, 51, 54, 58, 66, 81, 85, 92, 101,
}
...
func (p *XMLParser) Prolog() (localctx IPrologContext) {
	...
	for _la == XMLParserName || _la == XMLParserS {
		{
			p.SetState(33)
			p.Attribute()
		}
...
func (s *AttributeContext) AllS() []antlr.TerminalNode {
	return s.GetTokens(XMLParserS)
}

func (s *AttributeContext) S(i int) antlr.TerminalNode {
	return s.GetToken(XMLParserS, i)
}
