...
// EnterGoType is called when production goType is entered.
func (s *BaseGolangListener) EnterGoType(ctx *GoTypeContext) {}

// ExitGoType is called when production goType is exited.
func (s *BaseGolangListener) ExitGoType(ctx *GoTypeContext) {}
