...
public interface GolangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GolangParser#goType}.
	 * @param ctx the parse tree
	 */
	void enterGoType(GolangParser.GoTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link GolangParser#goType}.
	 * @param ctx the parse tree
	 */
	void exitGoType(GolangParser.GoTypeContext ctx);
	/**
