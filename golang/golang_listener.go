...
type GolangListener interface {
	...
	// EnterGoType is called when entering the goType production.
	EnterGoType(c *GoTypeContext)
	...
	// ExitGoType is called when exiting the goType production.
	ExitGoType(c *GoTypeContext)
