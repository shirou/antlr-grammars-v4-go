...
func (v *BaseSQLiteVisitor) VisitSql_error(ctx *Sql_errorContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSQLiteVisitor) VisitCte_table_name(ctx *Cte_table_nameContext) interface{} {
	return v.VisitChildren(ctx)
}
