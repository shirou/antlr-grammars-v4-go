...
type SQLiteListener interface {
	...
	// EnterSql_error is called when entering the sql_error production.
	EnterSql_error(c *Sql_errorContext)
	...
	// ExitSql_error is called when exiting the sql_error production.
	ExitSql_error(c *Sql_errorContext)
