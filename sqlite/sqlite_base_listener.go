...
// EnterSql_error is called when production sql_error is entered.
func (s *BaseSQLiteListener) EnterSql_error(ctx *Sql_errorContext) {}

// ExitSql_error is called when production sql_error is exited.
func (s *BaseSQLiteListener) ExitSql_error(ctx *Sql_errorContext) {}
